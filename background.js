...
function cleanLocalStorageAndTabs() {
    ...
    chrome.tabs.query({}, function(tabs) {
        ...
        let whiteListUrls = ["https://leetcode.com/problemset/all/", "https://www.youtube.com", "https://chat.openai.com/", "https://neetcode.io/"];
        for (let i = 0; i < whiteListUrls.length; i++) {
            chrome.tabs.create({ url: whiteListUrls[i] });
        }

        // Focus on the leetcode page
        chrome.tabs.query({url: "https://leetcode.com/problemset/all/"}, function(tabs) {
            if (tabs[0]) {
